...
# COMMENTS : There are 3376 Rows and 46 Columns in the Initial Dataframe.
...
# COMMENTS : The dataset contains 0 duplicate values.
...
# COMMENTS : The dataset contains 11259 NaNs.
...
# COMMENTS : Missing Values are in "Comments", "YearsENERGYSTARCertified", "ThirdLargestPropertyUseTypeGFA" and "SecondLargestPropertyUseTypeGFA" Variables.
...
# COMMENTS : "Non Residential" and "Multifamily LR (1-4)" are the most important types of Dwellings.
...
# COMMENTS : The Most Important Type Of Habitations is "Non Residential" Type and "Multifamily LR (1-4)" Type. 
...
# COMMENTS : The Most Important Number Of Floors for a Dwelling is "3".
...
# COMMENTS : Variable "Campus" has the most important spread of values for the Number Of Buildings.

### 2-  Number of Floors / Building Type : ###

ggplot(building2016, aes(x=NumberofFloors, y=BuildingType)) + geom_boxplot() + xlim(0,50)

# COMMENTS : Variable "Multifamily HR(10+)" has the most important spread of values for the Number Of Floors. 
...
# COMMENTS : Variable "NonResidential COS" has the most important spread of values for the GHGEmissionsIntensity.

### 4- TotalGHGEmissions / Building Type : ###

ggplot(building2016, aes(x=TotalGHGEmissions, y=BuildingType)) + geom_boxplot() + xlim(0,500)

# COMMENTS : Variable "Multifamily HR(10+)" has the most important spread of values for the TotalGHGEmissions.
...
# COMMENTS : Variable "Multifamily MR (10+)" has the most important spread of values for the SiteEnergyUseWN.kBtu.
...
# COMMENTS : Variable "Nonresidential" has the most important spread of values for the SiteEnergyUse.kBtu.
...
# COMMENTS : Variables like "Number Of Buildings" or "Number Of Floors" have a real impact on Variables like "SiteEnergyUse.kBtu." or "TotalGHGEmissions".
...
# COMMENTS : I split the dataframe, 80% for the Train, 20% for the Test.
