...
### 1- TARGET : TotalGHGEmissions : ### END
...
# Fortunately glmnet() automatically performs this standardization. 
...
# Conclusion : The R-squared turns out to be 0,91. That is, the best model was able to explain 91.99% of the variation in the response values of the training data.
...
X_matrix_NRJ <- data.matrix(building2016nonres[, c('GHGEmissionsIntensityPerFloor', 'TotalGHGEmissionsPerFloor', 'EnergyUsePerBuilding', 'EnergyUsePerFloor', 'GFAPerFloor', 'GFAPerBuilding','GHGEmissionsIntensity','TotalGHGEmissions','ThirdLargestPropertyUseTypeGFA','SecondLargestPropertyUseTypeGFA','LargestPropertyUseTypeGFA','NaturalGas.kBtu.','NaturalGas.therms.','Electricity.kBtu.','Electricity.kWh.','PropertyGFABuilding.s.','PropertyGFAParking','PropertyGFATotal','NumberofFloors','NumberofBuildings')])
...
# Conclusion : The R-squared turns out to be 0,99. That is, the best model was able to explain 91.99% of the variation in the response values of the training data.

# Find MAE :

mae(actual = y_target_NRJ, predicted = y_predicted)

# Conclusion : MAE = 480770

# Find MSE :

mse(actual = y_target_NRJ, predicted = y_predicted)

# Conclusion : MSE = 3.335012e+12

# Find RMSE :

rmse(actual = y_target_NRJ, predicted = y_predicted)

# Conclusion : RMSE = 1826201
...
train_x = data.matrix(train[, c('GHGEmissionsIntensityPerFloor', 'TotalGHGEmissionsPerFloor', 'EnergyUsePerBuilding', 'EnergyUsePerFloor', 'GFAPerFloor', 'GFAPerBuilding', 'GHGEmissionsIntensity','TotalGHGEmissions','ThirdLargestPropertyUseTypeGFA','SecondLargestPropertyUseTypeGFA','LargestPropertyUseTypeGFA','NaturalGas.kBtu.','NaturalGas.therms.','Electricity.kBtu.','Electricity.kWh.','PropertyGFABuilding.s.','PropertyGFAParking','PropertyGFATotal','NumberofFloors','NumberofBuildings')])

train_y = train$TotalGHGEmissions

# Define Predictor and Response Variables in Testing Set :

test_x = data.matrix(test[, c('GHGEmissionsIntensityPerFloor', 'TotalGHGEmissionsPerFloor', 'EnergyUsePerBuilding', 'EnergyUsePerFloor', 'GFAPerFloor', 'GFAPerBuilding', 'GHGEmissionsIntensity','TotalGHGEmissions','ThirdLargestPropertyUseTypeGFA','SecondLargestPropertyUseTypeGFA','LargestPropertyUseTypeGFA','NaturalGas.kBtu.','NaturalGas.therms.','Electricity.kBtu.','Electricity.kWh.','PropertyGFABuilding.s.','PropertyGFAParking','PropertyGFATotal','NumberofFloors','NumberofBuildings')])
...
# Conclusion : MSE = 1.408897e+14

# MAE :

caret::MAE(test_y, pred_y) 

# Conclusion : MAE = 1276402

# RMSE :

caret::RMSE(test_y, pred_y) 

# Conclusion : RMSE = 11869695
