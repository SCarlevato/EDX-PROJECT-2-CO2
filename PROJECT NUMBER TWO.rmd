...
# Loading csv file "Building 2016" :

building2016 <- read.csv("/Users/sylvaincarlevato/BRUCEBARONHEAVEN/2016_Building_Energy_Benchmarking.csv")

# Visualization of the "Building 2016" Dataframe :
...
# Number of Rows and Columns of the Initial Dataset :

dim(building2016)

# Types of Qualitative and Quantitative Variables of the Initial Dataset :

str(building2016)

# Quantification of Duplicate Values of the Initial Dataset :

sum(duplicated(building2016))

# Statistical Informations of the Initial Dataset :

summary(building2016)

# B- Missing Values :

# Location of NaNs in the Dataset :

is.na(building2016)

# Sum of NaNs in Dataset :

sum(is.na(building2016)) 

## The dataset contains 11259 NaNs.##

# List of Variables and their Types of the Entire Dataset :
...
# Other Visualizations of Missing Dataset Values :
...
# Visualization of the First 10 Values of the TotalGHGEmissions Column :

ghge <- building2016 %>% select(starts_with("TotalGHGEmissions"))

ghge[1:10,]

# Descriptive Statistics of the TotalGHGEmissions Column :

summary(ghge)

# SiteEnergyUseWN(kBtu) :

# Visualization of the First 10 Values of the SiteEnergyUseWN(kBtu) Column :

energ <- building2016 %>% select(starts_with("SiteEnergyUseWN.kBtu."))

energ[1:10,]

# Descriptive Statistics of the SiteEnergyUseWN(kBtu) Column :

summary(energ)

# D- Selection of the type of dwellings :

# Type of Buildings to choose:

building2016 %>% select(BuildingType)

# Basic Piechart of Dwellings :

pie(table(building2016$BuildingType), main = "Type of Habitations")

# Selection of Buildings not intended for Housing:
...
## The Most Important Type Of Habitations is "Non Residential" Type and "Multifamily LR (1-4). For my study, I am interested in Non Residential Type. ##
...
## The Most Important Number Of Floors for a Dwelling is "3". ##
...
## Multifamily HR(10+) has the most important spread of values for the Number Of Buildings. ##

# Number of Floors / Building Type :

ggplot(building2016, aes(x=NumberofFloors, y=BuildingType)) + geom_boxplot() + xlim(0,50)

## Multifamily HR(10+) has the most important spread of values for the Number Of Floors. ##

# GHGEmissionsIntensity / Building Type :

ggplot(building2016, aes(x=GHGEmissionsIntensity, y=BuildingType)) + geom_boxplot() + xlim(0,20)

## NonResidential COS has the most important spread of values for the GHGEmissionsIntensity. ##

# TotalGHGEmissions / Building Type :

ggplot(building2016, aes(x=TotalGHGEmissions, y=BuildingType)) + geom_boxplot() + xlim(0,500)

## Multifamily HR(10+) has the most important spread of values for the TotalGHGEmissions. ##

# SiteEnergyUseWN.kBtu. / Building Type :
...
## Multifamily MR (10+) has the most important spread of values for the SiteEnergyUseWN.kBtu. ##

# SiteEnergyUse.kBtu. / Building Type :
...
## Multifamily MR (10+) has the most important spread of values for the SiteEnergyUse.kBtu. ##
...
## Variables like Number Of Buildings or Number Of Floors have a real impact on Variables like SiteEnergyUse.kBtu. or TotalGHGEmissions ##
...
'GHGEmissionsIntensityPerFloor', 'TotalGHGEmissionsPerFloor', 'EnergyUsePerBuilding', 'EnergyUsePerFloor', 'GFAPerFloor', 'GFAPerBuilding', 'GHGEmissionsIntensity','SiteEnergyUseWN.kBtu.','SiteEnergyUse.kBtu.','ThirdLargestPropertyUseTypeGFA','SecondLargestPropertyUseTypeGFA','LargestPropertyUseTypeGFA',
...
# The lambda value that minimizes the test MSE turns out to be 51.
